  ...
  groups: [
    {
      ...
      items: [
        {
          q: '対象地域はどちらでしょうか？',
          a: '全国どこでも対応可能です（離島は配送不可能な商品がございますので、都度ご相談となります）。遠方のお客様にはオンラインでのご相談も承っておりますので、地域に関わらずお気軽にご相談くださいませ。また遠方の場合においても、ご希望内容に応じて現地での対応が可能な場合がございます。',
        },
        {
        ...
        {
          q: 'どのような支払方法が可能ですか？',
          a: '銀行振込でのお支払いとなります。商品ご購入額や工事内容により、ご分割でのお支払いを利用いただける場合もございます。',
        },
        {
          q: '提案は何回まで提案してもらえますか？',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          a: '営業活動を行わずとも、住宅市場の潜在顧客層にカグラクを通じて商品情報が届きます。新たな販売チャネルを獲得でき、ブランドや商品の価値を高めるサポートが可能です。また、カグラクのご利用には業務フローを変更する必要は一切ございませんので、業務負荷が増えるということもありません。',
        },
        {
          q: '今後追加されるサービスはありますか？',
