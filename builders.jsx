...
const BUILDERS = {
  ...
  heroTitleJa: '工務店様・ハウスメーカー様',

  lead: {
    eyebrow: 'WHY KAGURAKU',
    title: ['家具選びから設置まで、', { em: 'すべてお任せ' }, '。'],
    body: '家具・カーテン・照明の選定から物流・設置までを一気通貫でご提供。大切な施主様の理想の空間をカタチにして、企業価値を高めます。',
  },
  ...
  features: [
    {
      ...
      body: 'コーディネートを事例写真としてお使いいただけます。施主様への資料や、貴社の販促に活用いただくことで、住宅のご提案のみならずライフスタイルへのご提案が可能となります。',
