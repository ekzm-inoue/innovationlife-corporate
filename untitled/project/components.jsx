    ...
    <header className={`il-header ${scrolled ? 'is-scrolled' : ''}`}>
      <div className="il-header__inner">
        ...
        <div className="il-header__cta">
          <a className="il-btn il-btn--ghost" href="#contact" style={{ padding: '14px 22px', fontSize: 12 }}>
            お問い合わせ
        ...
        <div className="il-contact">
          <div className="il-contact__body">
            ...
            <div className="il-contact__paths">
              ...
              <a key={p.num} className="il-contact__path" href="#contact-form">
          ...
          <div className="il-footer__sitemap">
            ...
            <div className="il-footer__col">
              ...
              <ul>
                ...
                <li data-comment-anchor="86f5b3a1ba-li-592-17"><a href="company.html">4FULグループ</a></li>
              </ul>
            </div>
            <div className="il-footer__col">
              ...
              <ul>
                ...
                <li><a href="case-list.html">事例紹介</a></li>
              </ul>
            </div>
            <div className="il-footer__col">
...
Object.assign(window, {
  ...
  ILCompany, ILNews, ILFAQ, ILContact, ILFooter
});