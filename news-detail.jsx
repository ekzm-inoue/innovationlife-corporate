...
const NEWS_ARTICLES = {
  ...
  'b004': {
    date: '2026.06.28',
    cat: '事例紹介',
    title: '【施工事例】爽やかなカラーと自然の癒しでまとめた、オフィスのインテリア提案事例',
    author: 'INNOVATION LIFE 事務局',
    lede: 'いつもカグラクをご利用いただき、誠にありがとうございます。',
    body: [
      { type: 'p', text: '今回は、ある企業のオフィスを一新したカグラクの最新コーディネート事例をご紹介いたします。' },
      { type: 'p', text: '「オフィスのコーディネートは自宅には関係がない」と感じられるかもしれませんが、玄関やリビングにもそのまま応用できるプロの工夫が多く含まれています。ぜひ最後までご覧ください。' },
      { type: 'h2', text: 'テーマは「爽やかなカラー」と「自然の癒し」' },
      { type: 'p', text: '今回のコーディネートでは、清潔感のある色合いに観葉植物の緑を組み合わせ、働く方も来客の方もリラックスして過ごせる空間を目指しました。' },
      { type: 'h2', text: '会議室 — トーンを揃えた多色使い' },
      { type: 'p', text: 'ブルーやグレーのチェアをミックスして配置いたしました。明るさのトーンを揃えることで、複数の色を使ってもまとまり良くおしゃれに見せられる、コーディネーターの定番テクニックです。' },
      { type: 'p', text: 'ご自宅のダイニングチェアやリビングのクッションを選ぶ際にも、同じ考え方で色を組み合わせると、空間に統一感を出しやすくなります。' },
      { type: 'h2', text: '休憩スペース — 丸テーブルで生まれるカフェのような時間' },
      { type: 'p', text: '木目の丸テーブルに、曲線が美しい黒のチェアを合わせました。窓際に観葉植物を配置することで、視線の抜けと癒しを両立しています。' },
      { type: 'p', text: 'ご自宅でも、四角ではなく「丸テーブル」を選ぶことで、省スペースで会話の弾むカフェのような空間がつくれます。玄関ホールやリビングの一角にもおすすめのレイアウトです。' },
      { type: 'h2', text: '今回のコーディネート写真' },
      { type: 'imgrow', items: [
        { src: 'assets/blog004_1.jpg', caption: '休憩スペース：丸テーブルと曲線チェア、観葉植物の組み合わせ' },
...
const BLOG_ORDER = ['b001', 'b002', 'b003', 'b004'];
